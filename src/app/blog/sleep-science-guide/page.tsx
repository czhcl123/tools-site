...
export async function generateMetadata({ searchParams }: { searchParams: Promise<{ lang?: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      canonical: `https://tools-site-production.up.railway.app${lang === 'zh' ? '/zh/blog/sleep-science-guide' : '/blog/sleep-science-guide'}`,
      languages: { 'zh-CN': '/zh/blog/sleep-science-guide', 'en-US': '/blog/sleep-science-guide', 'x-default': '/blog/sleep-science-guide' },
    },
  }
}
