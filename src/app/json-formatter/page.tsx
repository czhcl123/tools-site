...
export async function generateMetadata({
  ...
  const data = {
    ...
    en: {
      title: 'Online JSON Formatter_API & Config Debugging_ Practical Tools',
      description: 'Paste JSON, get it formatted, beautified, minified, or validated in one click. Custom indent (2/4/Tab). Errors shown with line and column. Perfect for API responses, config files, and webhook payloads. Runs locally, nothing uploaded.',
    },
  }
