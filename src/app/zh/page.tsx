  ...
  mainEntity: [
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'Yes. All 12 tools are completely free with no premium tier, no usage limits, and no signup required.',
      },
    },
    {
      '@type': 'Question',
...
export async function generateMetadata({
  ...
  const titles = {
    zh: { default: '实用计算器 - 12 个免费在线工具,即开即用', template: '%s | 实用计算器' },
    en: { default: 'Practical Tools — 12 Free Online Calculators & Utilities', template: '%s | Practical Tools' },
  }
  const descriptions = {
    zh: '12 个免费在线工具:折扣计算、BMI、睡眠计算器 / 90 分钟睡眠周期、倒计时、农历、单位换算、QR 码、字数统计、JSON 格式化、HEIC 转 JPG、发票生成。无需注册,无需下载,所有处理在浏览器本地完成。',
    en: '12 Free Online Calculators and utilities — discount, BMI, sleep cycle, countdown, lunar calendar, unit converter, QR code, word counter, JSON formatter, HEIC to JPG, invoice generator. No signup, no download, no tracking. All processing runs in your browser.',
  }
