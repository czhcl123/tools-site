      ...
      <div className="min-h-screen bg-gray-50">
        <header className="bg-white shadow-sm sticky top-0 z-10">
          <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
            ...
            <a href={lang === 'zh' ? '/unit-converter' : '/zh/unit-converter'} className="text-xs px-3 py-1 border border-gray-200 rounded-full hover:bg-gray-50">
              {lang === 'zh' ? 'EN' : '中文'}
            </a>
          </div>
        </header>
            ...
            <aside className="lg:col-span-3">
              <div className="bg-white rounded-xl p-5 shadow-sm border border-gray-100 sticky top-20">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  <li><a href="/sleep-calculator" className="text-orange-500 hover:underline">😴 睡眠计算器</a></li>
                </ul>
              </div>
            </aside>
          </div>
